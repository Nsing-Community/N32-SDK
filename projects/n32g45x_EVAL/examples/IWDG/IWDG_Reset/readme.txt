...
3、使用说明
    ...
    使用方法：
        在KEIL下编译后烧录到评估板，上电后，PA8控制的指示灯不停的闪烁。说明IWDG正常喂狗，代码正常运行。
...
3. Instructions for use
    ...
    Instructions:
        After compiling in KEIL, it was burned to the evaluation board. After powering on,the indicator controled by PA8 pin kept flashing. The IWDG feeds the dog properly and the code runs properly.
