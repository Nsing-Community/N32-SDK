...
3、使用说明
    ...
    2.将电脑主机和开发板连接在同一网段内。
    3.编译后下载程序复位运行。
    4.串口工具将会打印信息，包括开发板被分配到的IP地址（如果使能了DHCP）。
    5.在电脑主机打开浏览器，直接输入ip地址。
    6.浏览器将会显示简单的网页信息。

4、注意事项
    1.先插入网线，再将开发板复位运行。
    2. N32G457QE_EVB V1.0 开发板使用 ETH 需要将跳线 J16、J17连接起来，N32G457QE_EVB V1.3 开发板使用 ETH 需要将跳线 J13、J48连接起来。
...
2. Use environment
    ...
    /* Hardware environment: the corresponding development hardware platform */
        Development board: N32G457QEL_EVB V1.3
...
3. Instructions for use
	...
	3. After compiling, the downloaded program is reset and running.
	4. The serial port tool will print information, including the IP address assigned to the development board (If DHCP is enabled).
	5. Open the browser on the PC and enter the IP address.
	6. The browser will display simple web page information.

4. Matters needing attention
	1. Insert the network cable and reset the development board.
	2. N32G457QE_EVB V1.0 development board uses ETH to connect jumpers J16 and J17, N32G457QE_EVB V1.3 development board uses ETH to connect jumpers J13 and J48.
