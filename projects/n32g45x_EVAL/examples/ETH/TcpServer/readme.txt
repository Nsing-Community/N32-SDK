...
4、注意事项
    1.先插入网线，再将开发板复位运行。
    2.电脑主机和开发板在同一网段。
    3. N32G457QE_EVB V1.0 开发板使用 ETH 需要将跳线 J16、J17连接起来，N32G457QE_EVB V1.3 开发板使用 ETH 需要将跳线 J13、J48连接起来。
...
4. Matters needing attention
	...
	3. N32G457QE_EVB V1.0 development board uses ETH to connect jumpers J16 and J17, N32G457QE_EVB V1.3 development board uses ETH to connect jumpers J13 and J48.
