...
4、注意事项
   PLL输出频率必须大于等于32MHz,当MCO输出PLLCLK时，MCO输出最大值不得超过PLLCLK的二分频
...
4. Matters needing attention
   The PLL frequency must be greater than or equal to 32MHz,when MCO outputs PLLCLK,the maximum output value of MCO shall not exceed PLLCLK/DIV2 