...
3. 使用说明
    ...
    描述Demo的测试步骤和现象 
         ...
         3. 枚举成功后，Host发送GET_REPORT指令获取Report数据，Host发送SET_REPORT指令后数据储存在HID_ReportBuffer
...
3. Instructions for use
    ...
    Describe the test steps and phenomena of Demo 
       ...
       3. After successful enumeration, the host sends GET_REPORT command to obtain the report data, and the data is stored in the HID_ReportBuffer 
          after the host sends the SET_REPORT command
